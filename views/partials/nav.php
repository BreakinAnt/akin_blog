          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <?php 
                ...
                $onHome         = urlIs("/");
                $onAbout        = urlIs("/about");
                $onContact      = urlIs("/contact");
              ?>
              <a href="/" <?php echo $onHome ? $activeClass : $inactiveClass ?> >Home</a>
              <a href="/about" <?php echo $onAbout ? $activeClass : $inactiveClass ?> >About</a>
              <a href="/contact" <?php echo $onContact ? $activeClass : $inactiveClass ?> >Contact</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
